...
| **Phantom Hunt** | An asymmetric 3-vs-1 multiplayer Java/JavaFX game with client-server networking, lobbies, chat, spectators and scoring. | [Code](https://github.com/HerRei/PhantomHunt) · [Showcase](https://herrei.github.io/PhantomHunt/) · [Early concept mockup](https://herrei.github.io/mockup/) |
| **Nature Inventory Delta AI** | Local tools for querying and visualizing changes in the Basel-Stadt nature inventory. | [Code](https://github.com/HerRei/nature-inventory-delta-ai) |
